...
```
**vsync_back_porch** : a value of 30 has been reported by [https://github.com/FrancisSailor](FrancisSailor) to be way better for complex lvgl animations. 20 is the value I've been using otherwise (no animation).
